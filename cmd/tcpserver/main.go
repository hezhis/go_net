...
func main() {
	s := go_net.NewTcpServer(
		go_net.TcpSLocalAddr("127.0.0.1:6321"),
		go_net.TcpSHeadLen(2),
		go_net.TcpSMaxClientCount(2),
	)
	s.NewAgent = func(connector *go_net.TcpConnector) go_net.Agent {
